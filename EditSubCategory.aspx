...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class=" container">
<br /><br /><br /><br /><br /><br />
<div class="well-sm"><h3 class="alert-danger text-center" style="background-color:#000066; color: #FFFFFF;">Edit Sub Category</h3></div>
    <div class="row">
        <div class="col-md-8">
           <div class="row">
               <div class="col-md-3">
        ...
        <div class="row">
                <div class="col-md-12">
                <h4 class="alert-info text-center" style="background-color:#000066; color: #FFFFFF;"> All Category</h4>
                <br />
