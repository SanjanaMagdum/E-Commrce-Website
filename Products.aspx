...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <br />
    <div style="background-color:Black; position:relative; top: 61px; left: 0px; height: 76px;" 
        class="style3">
       
        <strong><em>
       
    <marquee>...___________PRODUCTS  AVAILABLE   FOR  YOU__________...</marquee></em></strong>
        </div>
    <div class="row">
