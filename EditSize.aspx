...
<div class="container">
  ...
  <br /><br /><br /><br />
    <div class="panel panel-primary">
      <div class="panel-heading"style="background-color:#000066; color: #FFFFFF;"><strong>Edit Size</strong></div>
          ...
          <div class="row">
               <div class="col-sm-6">
                  ...
                  <asp:Button ID="btnUpdateSubCategory" CssClass="btn btn-primary" runat="server" 
                          Text="UPDATE" onclick="btnUpdateSubCategory_Click" BackColor="#000066" />
                  </div>
               ...
               <div class="col-sm-6">
                ...
                <h4 class="alert-info text-center" 
                        style="color: #FFFFFF; background-color: #000066"> <strong>All Size</strong></h4>
                <br />
      ...
      <div class="panel-footer"style="background-color:#000066; color: #FFFFFF;"><strong>Panel Footer</strong></div>
    </div>
