    ...
    <div class="row" style="padding-top: 20px;">
        ...
        <div class="col-md-9">
             <div class="form-horizontal">
                <h3 class="style3"><strong>Delivery Address</strong></h3>
                <hr />
        ...
        <div class="col-md-12">
  <h3><strong>Choose Payment Mode</strong></h3>
            <hr />
            <ul class="nav nav-tabs">
             ...
             <div class="tab-content">
                                <div id="PlaceNPay" class="tab-pane fade in active">
                                    <h3><strong>Place your order and Pay using our </strong> <a href="acceptedpayments" target="_blank">
                                        <strong>Accepted Payments</strong></a><strong> channels, Your order will be dispatched upon receiving full payment.</strong></h3>
                                    <asp:Button ID="BtnPlaceNPay" CssClass=" btn btn-info" Font-Size="Large" 
                                        ...
                                        Text="Checkout &raquo;" BackColor="#000066" />
                                </div>
