...
public partial class EditSubCategory : System.Web.UI.Page
{
    ...
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["mywebsite_database.mdf"].ConnectionString);
    ...
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["mywebsite_database.mdf"].ConnectionString))
        {
            if (con.State == ConnectionState.Closed) { con.Open(); }
