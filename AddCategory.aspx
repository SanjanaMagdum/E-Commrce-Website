...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class ="form-horizontal ">
                ...
                <div class ="form-group">
                    ...
                    <div class ="col-md-6 ">
                        ...
                        <asp:Button ID="btnAddtxtCategory" CssClass ="btn btn-success " runat="server" 
                            Text="Add Category" OnClick="btnAddtxtCategory_Click" BackColor="#000066"   />
 ...
 <div class="panel panel-default">
               ...
               <div class="panel-heading" style="background-color:#000066; color: #FFFFFF;"> <strong>All Categories</strong></div>
