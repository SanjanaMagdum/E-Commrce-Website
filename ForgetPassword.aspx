<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgetPassword.aspx.cs" Inherits="E_Commrce_Website.ForgetPassword" %>
            ...
            <div class ="container ">
                <div class ="navbar-header">
                    ...
                    <a class ="navbar-brand" href ="Default.aspx" ><span ><img src="imagesilder/e-commerce-creative-eye-creative-image-8436971b277975c784a91f8a4eea5e12.png" 
                        ...
                        style="position:relative; top: -7px; left: 23px; height: 54px; width: 56px;" /></span></a><span 
                        class="style1"><a 
                ...
                <div class ="navbar-collapse collapse">
                    <ul class ="nav navbar-nav navbar-right">
                        ...
                        <li ><a href ="SignIn.aspx"style="color:Black;">SignIn</a> </li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class ="form-group">
                    ...
                    <div class ="col-md-6">
                        <asp:Button ID="btnResetPass" CssClass ="btn btn-default" runat="server" 
                            Text="Send" BackColor="#000066" ForeColor="White"  />
