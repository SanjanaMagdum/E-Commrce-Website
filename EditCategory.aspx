         ...
         <div class="form-group">
          ...
          <div class="form-group">
                        <asp:Button ID="btnUpdateBrand" CssClass ="btn btn-primary " runat="server" 
                            Text="UPDATE" onclick="btnUpdateBrand_Click" BackColor="#000066" 
                            BorderColor="#000066"  />
                    </div>
         </div>
          ...
          <div class="col-md-6">
             ...
             <div class="row">
                <div class="col-md-12">
                <h4 class="alert-info text-center"style="background-color:#000066; color: #FFFFFF;"> 
                    <strong>All Category</strong></h4>
                <br />
