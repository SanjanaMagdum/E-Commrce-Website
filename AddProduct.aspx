...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class ="container">
       <div class ="form-horizontal">
           ...
           <br />
           <br />
           <h2 class="style2"><strong>Add Product</strong></h2>
           <hr />
           ...
           <div class ="form-group">
                    ...
                    <div class ="col-md-6 ">
                        ...
                        <asp:Button ID="btnAdd" CssClass ="btn btn-success " runat="server" 
                            Text="ADD Product" OnClick="btnAdd_Click" BackColor="#000066"  />
   ...
   <hr />
    <div class="panel panel-primary">
      <div class="panel-heading"style="background-color:#000066;"><h2 class="center">
          <strong>Product Report</strong></h2> </div>
      ...
      <div class="panel-footer"style="background-color:#000066; color: #FFFFFF;">Panel Footer</div>
    </div>
